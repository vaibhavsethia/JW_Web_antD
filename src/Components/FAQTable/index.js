...
export class FAQTable extends Component {
  render() {
    return (
      <div className="pb5">
         <Collapse accordion>
            <Panel className="pl5 pr5 pt3" showArrow={true} header={<span className="f3 fw3 tc">This is the first question on the FAQ page ?</span>} key="1">
              <p className="pl5 pr5 f4 pt2 fw2">Culpa elit sunt pariatur anim in elit ut voluptate sunt veniam. Quis nulla voluptate est elit. Voluptate ea eu aute fugiat ut anim cupidatat consectetur sit eiusmod. Lorem enim ipsum id ullamco do consectetur consectetur occaecat non cillum est in amet officia. Lorem excepteur veniam cillum laborum tempor. Quis adipisicing ex est incididunt nisi magna enim occaecat.</p>
            </Panel>

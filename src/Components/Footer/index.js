      ...
      <div className="footer">
        <Row className="mb2">
          ...
          <Row className="b">Products</Row>
            <Row><a href="/" className="link-hover"><span className="fw2">MegaMine</span></a></Row>
          </Col>
          <Col xl={6} lg={6} md={12} sm={12} xs={24} className="col-gray tc">
          <Row className="b">Support</Row>
            <Row><a href="/contact" className="link-hover"><span className="fw2">Contact</span></a></Row>
            <Row><a href="/faq" className="link-hover"><span className="fw2">FAQs</span></a></Row>
        ...
        <Row className="tc">
          <Col>
            ...
            <span className="col-gray f5 fw1"><a href="/policy" className="link-hover">Privacy Policy</a></span>
          </Col>
        </Row>
      </div>
    )
